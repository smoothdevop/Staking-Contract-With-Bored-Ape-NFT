...
async function main() {
  ...
  await stakedToken
    .connect(impersonatedBoredApeUser)
    .approve(stakingContract.address, amount);
  console.log(
    await stakedToken.balanceOf(stakedToken.address),
    "balance........................"
  );

  await stakedToken
    .connect(impersonatedBoredApeUser)
    .transfer(stakingContract.address, ethers.utils.parseEther("20"));
  ...
  console.log(
    await stakedToken.balanceOf(stakingContract.address),
